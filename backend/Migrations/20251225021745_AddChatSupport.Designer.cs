...
namespace backend.Migrations
{
    ...
    [Migration("20251225021745_AddChatSupport")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Conversation", b =>
                {
                    b.HasOne("backend.Models.Member", "Reader")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.Member", b =>
                {
                    b.HasOne("backend.Models.Account", "Account")
                        .WithOne()
                        .HasForeignKey("backend.Models.Member", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Models.Staff", b =>
                {
                    b.HasOne("backend.Models.Account", "Account")
                        .WithOne()
                        .HasForeignKey("backend.Models.Staff", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
